...
namespace CheckupAddIn
{
    ...
    /// </summary>
    /// <remarks>
    /// The GUID C64EE7DC-2F80-45E1-985D-02C43D96731C must be identical in three places:
    ...
    /// </remarks>
    [ComVisible(true)]
    [Guid("C64EE7DC-2F80-45E1-985D-02C43D96731C")]
    ...
    public class StandardAddInServer : ApplicationAddInServer
    {
        ...
        private void CreateButtonDefinition()
        {
            ...
            _checkupButton = controlDefs.AddButtonDefinition(
                ...
                ClientId: "{C64EE7DC-2F80-45E1-985D-02C43D96731C}",
        ...
        private void OnCheckupButtonClick(NameValueMap context)
        {
            try
            {
                ...
                PerfLogger.LogSession("Checkup 2027 activated");
