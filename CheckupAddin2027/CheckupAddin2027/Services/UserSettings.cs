...
namespace CheckupAddIn.Services
{
    ...
    ///   <c>HKCU\Software\Checkup 2027\Presets</c> (JSON blob, REG_SZ).
    ...
    /// <list type="number">
    ///   <item>Registry <c>HKCU\Software\Checkup 2027\Presets</c> — user's saved customizations (takes priority).</item>
    ...
    /// <b>To reset a user:</b> delete <c>HKCU\Software\Checkup 2027\Presets</c> from their registry.
    /// </remarks>
