...
namespace CheckupAddIn.Services
{
    ...
    ///   1.  app.ThemeManager.ActiveTheme.Name — strongly-typed interop API, Inventor 2026.
    ...
    ///   UIStyle\Ribbon\RibbonAppearance registry value.
    /// AppearanceManager does not exist on Inventor.Application in Inventor 2026.
    ///
    ...
    internal static class ThemeLoader
    {
        ...
        private static void Apply(Window window, bool dark)
        {
            ...
            var uri = new Uri(
                $"pack://application:,,,/CheckupAddIn;component/Resources/{name}Theme.xaml",
                UriKind.Absolute);
