    ...
    public class CardTypeToBrushConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return (value as string) switch
            {
                ...
                "PrefixSuffix" => new SolidColorBrush(Color.FromRgb(0x7D, 0x3C, 0x98)),
                "Sort"         => new SolidColorBrush(Color.FromRgb(0x27, 0xAE, 0x60)),
                "BasicLogic"   => new SolidColorBrush(Color.FromRgb(0xC0, 0x39, 0x2B)),
