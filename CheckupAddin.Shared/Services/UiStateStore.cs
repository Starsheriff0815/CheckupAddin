...
namespace CheckupAddIn.Services
{
    ...
    internal static class UiStateStore
    {
        ...
        /// <summary>
        /// When true (set by the Design Harness), all size loads return defaults so windows
        /// open at their factory/code sizes instead of the developer's personally persisted ones.
        /// Has no effect in the shipped add-in (never set there).
        /// </summary>
