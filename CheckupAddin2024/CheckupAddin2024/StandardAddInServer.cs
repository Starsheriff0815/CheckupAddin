...
namespace CheckupAddIn
{
    ...
    /// </summary>
    /// <remarks>
    /// The GUID 4E7A2B9C-1D3F-4A5B-8C6D-E9F0A1B2C3D4 must be identical in three places:
    ...
    /// </remarks>
    [ComVisible(true)]
    [Guid("4E7A2B9C-1D3F-4A5B-8C6D-E9F0A1B2C3D4")]
    ...
    public class StandardAddInServer : ApplicationAddInServer
    {
        ...
        public void Activate(ApplicationAddInSite addInSiteObject, bool firstTime)
        {
            ...
            catch (Exception ex)
            {
                System.Windows.MessageBox.Show(
                    $"Checkup 2024 failed to initialize:\n{ex.Message}",
                    "Checkup 2024", System.Windows.MessageBoxButton.OK,
        ...
        private void CreateButtonDefinition()
        {
            ...
            _checkupButton = controlDefs.AddButtonDefinition(
                DisplayName: "Checkup 2024",
                InternalName: "CheckupAddIn_ShowWindow",
                Classification: CommandTypesEnum.kNonShapeEditCmdType,
                ClientId: "{4E7A2B9C-1D3F-4A5B-8C6D-E9F0A1B2C3D4}",
                DescriptionText: "Open Checkup 2024 – Sheet Metal inspection and property viewer",
                ToolTipText: "Checkup 2024\nOpen the Checkup 2024 property viewer window.",
        ...
        private void OnCheckupButtonClick(NameValueMap context)
        {
            ...
            {
                System.Windows.MessageBox.Show(
                    $"Could not open Checkup 2024 window:\n{ex.Message}",
                    "Checkup 2024", System.Windows.MessageBoxButton.OK,
                    System.Windows.MessageBoxImage.Warning);
            }
        }
        ...
        /// <summary>
        /// Returns the directory that contains Autodesk.CheckupAddIn2024.addin.
        /// Because the .addin file lives in each user's own AppData, this gives every user
        /// their own Checkup2024_Settings.json without touching other users' copies.
        /// Falls back to the DLL directory if the addin cannot be located via the API.
        /// </summary>
        private string FindAddinDirectory()
        {
            const string myGuid = "{4E7A2B9C-1D3F-4A5B-8C6D-E9F0A1B2C3D4}";
            try
            {
