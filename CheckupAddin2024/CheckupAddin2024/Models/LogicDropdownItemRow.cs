...
namespace CheckupAddIn.Models
{
    ...
    public sealed class LogicDropdownItemRow : INotifyPropertyChanged
    {
        ...
        private void Notify(string name) { var h = PropertyChanged; if (h != null) h(this, new PropertyChangedEventArgs(name)); }
        ...
        public bool IsHighlighted
        {
            ...
            set { if (_isHighlighted == value) return; _isHighlighted = value; Notify("IsHighlighted"); }
        }

        public CatalogDropdownItem Item      { get; }
        public string              GroupName { get { return Item.GroupName; } }
