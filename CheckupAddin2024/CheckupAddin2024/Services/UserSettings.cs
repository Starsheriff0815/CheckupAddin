...
namespace CheckupAddIn.Services
{
    ...
    /// </summary>
    /// <remarks>
    /// <b>File location (2024):</b> same folder as <c>Autodesk.CheckupAddIn2024.addin</c>
    ...
    ///   <c>HKCU\Software\Checkup 2024\Presets</c> (JSON blob, REG_SZ).
    ...
    ///   1. Registry <c>HKCU\Software\Checkup 2024\Presets</c> — user's saved customizations (takes priority).
    ...
    /// <b>To reset a user:</b> delete <c>HKCU\Software\Checkup 2024\Presets</c> from their registry.
    /// </remarks>
