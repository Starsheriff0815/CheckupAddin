...
namespace CheckupAddIn.Services
{
    ...
    /// Factory defaults come from Checkup2025_Settings.json (passed via constructor).
    /// Falls back to empty placeholder presets if UserSettings failed to load.
    /// </summary>
    /// <remarks>
    /// Registry location: HKCU\Software\Checkup 2025\Presets  (REG_SZ — JSON blob)
    ///
    ...
    /// defaults from Checkup2025_Settings.json — not hardcoded C# values.
    ///
    ...
    {
        private const string RegKey   = @"Software\Checkup 2025";
        ...
        /// <summary>Deletes the registry value — next Load() will return external defaults from Checkup2025_Settings.json.</summary>
