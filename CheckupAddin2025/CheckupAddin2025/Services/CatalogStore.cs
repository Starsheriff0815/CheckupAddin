...
namespace CheckupAddIn.Services
{
    ...
    ///   2. AppData\Checkup 2025\Catalogs\  — personal unlocked copies created by the user.
    ///
    ...
    public class CatalogStore
    {
        ...
        private readonly string _localDir;        // AppData\Checkup 2025\Catalogs\
        ...
        public void Save(CatalogData catalog)
        {
            ...
            catch (Exception ex) { DiagLogger.Log("catalog", "Save failed for '" + (catalog != null ? catalog.Name : "") + "': " + DiagLogger.S(ex.Message)); }
        }
