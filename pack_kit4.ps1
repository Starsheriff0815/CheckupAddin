<#
.SYNOPSIS
  Builds CheckupAddin 2026 and packages it as the Kit #4 experiment bundle.

.DESCRIPTION
  1. Builds CheckupAddin2026 in Release/x64.
  2. Stages all deployable files into dist\kit4\CheckupExperiment2026\.
  3. Zips the staged folder to dist\kit4\CheckupExperiment2026_kit4.zip.
...
$root    = $PSScriptRoot
$year    = 2026
$kitDir  = Join-Path $root "dist\kit4\CheckupExperiment2026"
$zipPath = Join-Path $root "dist\CheckupExperiment2026_kit4.zip"
...
Write-Host "Transfer this ZIP to the test machine and follow dist\kit4\CheckupExperiment2026\README_DEPLOY.md." -ForegroundColor Yellow
